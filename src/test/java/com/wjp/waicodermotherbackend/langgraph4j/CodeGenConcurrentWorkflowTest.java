...
class CodeGenConcurrentWorkflowTest {
    ...
    void testConcurrentWorkflow() {
        WorkflowContext result = new CodeGenConcurrentWorkflow().executeWorkflow("To create a technical blog website, it is necessary to display programming tutorials and system architectures.");
